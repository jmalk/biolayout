...
public final class Vertex implements Comparable<Vertex>
{
    ...
    // Overloaded setVertexLocation for 4D coordinate
    public void setVertexLocation(float locationX, float locationY, float locationZ, float locationW)
    {
        point.setLocation(locationX, locationY, locationZ, locationW);
    }
    ...
    // Overloaded setComponentDisplacement for four dimensions in case needed later
    public void setComponentDisplacement(float ratio, float width, float height, float zValue, float wValue)
    {
        point.setLocation( (point.getX() + width) / ratio, (point.getY() + height) / ratio, (zValue / ratio) + 500, (wValue / ratio) + 500 );
    }
    ...
    // Additional manipulator for w coordinate
    public void setWvalue(float wValue)
    {
        point.w = wValue;
    }
